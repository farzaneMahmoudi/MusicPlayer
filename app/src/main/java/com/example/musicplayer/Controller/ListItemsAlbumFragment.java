 ...
 */
public class ListItemsAlbumFragment extends Fragment {
    ...
    private ListItemsAlbumFragment.Adapter musicAdapter;
    ...
    public static ListItemsAlbumFragment newInstance(Album album) {

        Bundle args = new Bundle();

        args.putSerializable(ARG_ALBUM, album);
        ListItemsAlbumFragment fragment = new ListItemsAlbumFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public ListItemsAlbumFragment() {
    ...
    private void setUI() {
        mTextViewSinger.setText(mAlbum.getSinger());
        mTextView.setText(mAlbum.getAlbumName());
        if (BitmapFactory.decodeFile(mAlbum.getCoverMusic()) == null) {
            mImageViewCoverAlbum.setImageResource(R.drawable.music_cover);
        } else {
            mImageViewCoverAlbum.setImageBitmap(BitmapFactory.decodeFile(mAlbum.getCoverMusic()));
        }

    }

    private void setAdapter() {
        musicList = mMediaPlayerControler.getMusics(getContext(), mAlbum);
    ...
    private class Adapter extends RecyclerView.Adapter<ListItemsAlbumFragment.MusicHolder> {
        ...
        @NonNull
        @Override
        public ListItemsAlbumFragment.MusicHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(getActivity());
            View view = inflater.inflate(R.layout.music_item, parent, false);
            return new ListItemsAlbumFragment.MusicHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull ListItemsAlbumFragment.MusicHolder holder, int position) {
